...
case FVIM_SPC_ENT_ESC:       if (check_mod_and_remove_it(SHFT_MODS, true))
                              {
                                tap_code(KC_ENT);
      ...
      case BACKSP_DEL:      if (check_mod_and_remove_it(SHFT_MODS, false))
                            {
...
//                               = if (!get_mods()&SHFT_MODS && !get_mods()&ALT_MODS)
      case FVIM_SPC_ENT_ESC:       if (!(check_mod_and_remove_it(SHFT_MODS, false) || check_mod_and_remove_it(ALT_MODS, false)))
                                   {
