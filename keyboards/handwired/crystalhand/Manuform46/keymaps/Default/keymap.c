 ...
 * `--------+------+------+------+------+------'      		       `-------+------+------+------+------|--------|'
 * |CTR     |  ALT | GUI  | Left | Right|      |				   |      |      | LEFT | RIGHT |
 * `--------------------------------------------'       		    --------------------------------------------'
 
 *                 				|Backsp| L2   |	  		   			|Enter| Space| 
 *				   -----------------------------		    -----------------------------
 *                					 |      | TopR|		| TopL | SCRN  |
 *				   ------------------------------		    -----------------------------
 *								 	 |PGUP  |BotomR|	|BotttomL|END|
 Think of the thumb cluster as being flattened out.  For the right hand you rotate the 4 key thumb cluster 45 degrees clockwise.
 This will then match up better with the above
  ...
  */	
	...
	//|----+----+----+----+----+----|    |----+----+----+----+----+----|
		REST , Z  , X  , C  , V  , B  ,      N  , M  ,COMM,DOT,SLSH,REST,
	//|----+----+----+----+----+----|    |----+----+----+----+----+----|
	//`----+----+----+----+----+----'    `----+----+----+----+----+----'
				 LEFT,RIGHT,		    					UP  ,DOWN,
	//`----+----+----+----+----+----'   		 ----+----+----+----+----+----'
...
*/
	...
	_______, _______, _______, COLEMAK, _______, _______, _______, _______, \
