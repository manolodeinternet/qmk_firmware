...
extern void clear_oneshot_layer_state(oneshot_fullfillment_t state);
...
//		EQL, 1  , 2  , 3  , 4  , 5  ,     									 6  , 7  , 8  , 9 , 0  ,MINS,
	//,----+----+----+----+----+----.										,----+----+----+----+----+----.
/*TAB,*//*OSL(_LOWER),*/Q,   W  , E  , R  , T  ,    	                                    Y  , U  , I  ,  O,   P , /*BSLS,*/
	//|----+----+----+----+----+----|   									|----+----+----+----+----+----|
/*LCTRL,*/MOMM,   S  , D  , F  , G  ,	     									H  , J  , K  ,  L,   SCLN, /*QUOT,*/
	//|----+----+----+----+----+----|										|----+----+----+----+----+----|
/*LSFT,*/MOMD,   X  , C  , V  , B  ,										N  , M  , COMM, DOT, REST, /*RSFT,*/
	//|----+----+----+----+----+----|										|----+----+----+----+----+----|
//		MOMD,GRAVE,LBRC,RBRC,LALT,,												  ,LEFT,DOWN,UP ,RIGHT,LDWN,
	//`----+----+----+----+----+----'   									 `----+----+----+----+----+----'
	//							`----+----+----+'			`----+----+----'
										ESC,DEL,			 LGUI, ESC,
	//							`----+----+----+'			`----+----+----'
...
/*TAB,*/   Q  , W  , F  , P  , G  , 									     J  , L  , U  , Y  ,SCLN, /*BSLS,*/
	//|----+----+----+----+----+----| 									   |----+----+----+----+----+----|
/*ENTL*/MOMM  , R  , S  , T  , D  ,									         H  , N  , E  , I  , O,   /*ENT,*/
	//|----+----+----+----+----+----|									    |----+----+----+----+----+----|
/*LSFT,*/MOMD , X  , C  , V  , B  ,  									     K  , M  ,COMM,DOT ,REST, /*GRV,*/
	//|----+----+----+----+----+----| 									   |----+----+----+----+----+----|
...
/*TAB,*/  QUOT,COMM,DOT , P  , Y  , 								     F  , G  , C  , R  , L  , /*BSLS,*/
	//|----+----+----+----+----+----|    								|----+----+----+----+----+----|
/*ENT,*/MOMM  , O  , E  , U  , I  ,  								     D  , H  , T  , N  , S  , /*SLSH,*/
	//|----+----+----+----+----+----| 								   |----+----+----+----+----+----|
/*LSFT,*/ MOMD, Q  , J  , K  , X  ,  							         B  , M  , W  , V  ,REST, /*GRV ,*/
	//|----+----+----+----+----+----|    							   |----+----+----+----+----+----|
//		ESCT,LALT,LGUI,LEFT,RIGHT,BSPC,								    SPC,LEFT,RIGHT,UP ,DOWN,QUOT,
	//`----+----+----+----+----+----'  								 `----+----+----+----+----+----'
	//							`----+----+----+'			`----+----+----'
...
/*,*/   EXLM ,AT,LCBR,RCBR,PIPE,   							          UP  , 7  , 8 ,  9,  ASTR,  /*F12,*/
	//|----+----+----+----+----+----|   							 |----+----+----+----+----+----|
/*,*/   HASH ,DLR,LPRN,RPRN,GRAVE,     							      DOWN, 4  , 5 ,  6,      ,   /*,*/
	//|----+----+----+----+----+----|   							 |----+----+----+----+----+----|
/*,*/   MOMD,CIRC,LBRC,RBRC,TILD,    								  AMPR, 1  ,2  ,3   , REST,   /*,*/
	//|----+----+----+----+----+----|   							 |----+----+----+----+----+----|
//		    ,    ,    ,,   ,   ,    						       ,,   ,    ,    ,     ,
	//|----+----+----+----+----+----|  								  |----+----+----+----+----+----|
	//							`----+----+----+'			`----+----+----'
...
/*8,*/   1  , WWWX, 1  , 1  , 1  ,										  NO , 4  , 5  , 6  ,  PMNS, /*NO,*/ 
	//|----+----+----+----+----+----|									|----+----+----+----+----+----|
/*8,*/ MOMM, 1  , 1  , 1  , 1  ,										  NO , 1   , 2  ,  3 , PPLS, /*NO,*/
	//|----+----+----+----+----+----|									|----+----+----+----+----+----|
/*8,*/ MOMD, 1, 1  , 1  , 1  ,											  NO , 0  , 0  , DOT , REST, /*NO,*/
	//|----+----+----+----+----+----|									|----+----+----+----+----+----|
...
/*_______,*/     KC_MOMM, OSL(_LOWER),       M(1), _______, _______,	 _______, _______,   KC_UP,  _______, _______, /*_______,*/
/*M(7),*/        KC_MOMD,        M(9),    _______, _______, _______,     _______, KC_LEFT, KC_DOWN, KC_RIGHT, KC_REST, /*_______,*/
...
/*_______,*/KC_MOMD, _______, COLEMAK, _______, _______,            _______, _______, _______, _______, KC_REST, /*_______,*/
