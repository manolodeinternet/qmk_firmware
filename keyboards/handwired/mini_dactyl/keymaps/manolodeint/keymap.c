...
///////////////////////////////////////////////////////////////// ### BLOCK ### OF LINES TOO LONG !!! ###
//,--------------------------------------------------------------------------------------.  ,------------------------------------------------------------------------------------------.
//  MO(_APPS),/*LT(_APPS, KC_Q),*/ LT(_POWR, KC_W),   RESET/*KC_E*/, LT(_DIAE, KC_R), LT(_SYMB, KC_T),                 KC_Y,            KC_U,              KC_I, LT(_POWR, KC_O),   LT(_APPS, KC_P),
//|----------------+----------------+----------------+----------------+------------------|  |----------------+----------------+------------------+----------------+--------------------|
//     LSFT_T(KC_A),     CTL_T(KC_S),     ALT_T(KC_D),     GUI_T(KC_F), MO(_RGBL),/*LT(_ACCN, KC_G),*/      LT(_ACCN, KC_H),     GUI_T(KC_J),       ALT_T(KC_K),     CTL_T(KC_L),    LSFT_T(KC_SPC),
//|----------------+----------------+----------------+----------------+------------------|  |----------------+----------------+------------------+----------------+--------------------|
//  TO(_ALPH)/*LT(_DALY, KC_Z)*/, LT(_DVIM, KC_X), LT(_MOUS, KC_C), LT(_PVIM, KC_V), LT(_NUMB, KC_B),      LT(_SYMB, KC_N), LT(_PVIM, KC_M), LT(_FUNC, KC_ESC), KC_BSPC, RESET, /*LT(_DALY, KC_ENT),*/
  //|----+----+----+----+----+----|                   |----+----+----+----+----+----|
/*
  //                             `----+----+----+'     `----+----+----'
                                      KC_1, KC_2,        KC_A, KC_B,
  ...
  //                             `----+----+----+'     `----+----+----'
                                            KC_1,        KC_2,
  //                             `----+----+----+'     `----+----+----'
LT(_NUMB, KC_BSPC), MO(_PVIM), LT(_DALY, KC_DEL),        LT(_RGBL, KC_TAB), LT(_SYMB, KC_SPC), LT(_APPS, KC_ENT)
  //                             `----+----+----+'     `----+----+----'
*/
// ),
//'--------------------------------------------------------------------------------------'  '------------------------------------------------------------------------------------------'
...
//|---------|--------|---------+--------+----------| |---------|---------+---------+---------+----------|
     TO(_ALPH)/*_______*/, _______,  _______, _______, _______,     F(TIL_N),  _______,  _______,  _______, RESET, /*_______,*/
  //|----+----+----+----+----+----|                   |----+----+----+----+----+----|
  //              `----+----+----+'     `----+----+----'
  ...
  //              `----+----+----+'     `----+----+----'
                              KC_HOME,        KC_PGUP,
  //              `----+----+----+'     `----+----+----'
             KC_BSPC, KC_DEL, KC_DEL,          KC_ENT, KC_ENT, KC_SPC
  //              `----+----+----+'     `----+----+----'
),
//'------------------------------------------------' '--------------------------------------------------'
// END OF _ACCN 1
...
[_DIAE] = KEYMAP(  // layer 2 : RESET & diaeresis layer 
//,--------------------------------------------------.,-------------------------------------------------.
...
//|-----------+--------+---------+--------+----------||--------+---------+---------+---------+----------|
         TO(_ALPH)/*KC_P1*/,   KC_P2,    KC_P3,   KC_P4,   KC_P5,      KC_P6,    KC_P7,    KC_P8,    KC_P9, RESET, /*KC_P0,*/
  //|----+----+----+----+----+----|                   |----+----+----+----+----+----|
  //              `----+----+----+'     `----+----+----'
                          KC_ESC, KC_LALT,        KC_LGUI, KC_RCTRL,
  //              `----+----+----+'     `----+----+----'
...
//|--------------+--------------+---------------+--------------+-------------|  |-----------+------+------+------+----------|
           TO(_ALPH)/*KC_ENT*/,       KC_BSPC,         KC_TAB,        KC_EQL, TD(PENUMB),      TD(SLNUMB),  KC_1,  KC_2,  KC_3, RESET, /*KC_ASTR,*/
  //|----+----+----+----+----+----|                   |----+----+----+----+----+----|
  //              `----+----+----+'     `----+----+----'
                          KC_ESC, KC_LALT,        KC_LGUI, KC_RCTRL,
  //              `----+----+----+'     `----+----+----'
...
//|---------------+---------------+---------------+---------------+-------------|  |-----------------+---------------+---------------+---------------+-----------------|
        TO(_ALPH)/*TD(Z_EXCL)*/,     TD(X_QUES),        KC_LABK,        KC_RABK,    KC_ASTR,      LT(_SYMB, KC_NO),        KC_LCBR,        KC_RCBR,        KC_COLN, RESET, /*KC_SCLN,*/
  //|----+----+----+----+----+----|                   |----+----+----+----+----+----|
  //              `----+----+----+'     `----+----+----'
                          KC_ESC, KC_LALT,        KC_LGUI, KC_RCTRL,
  //              `----+----+----+'     `----+----+----'
...
//|-------+-------+------------------+-------+----------||--------+--------+--------+---------+---------|
    TO(_ALPH)/*KC_F21*/, KC_F22, LT(_FUNC, KC_F23), KC_F24, XXXXXXX,    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, RESET, /*XXXXXXX,*/
  //|----+----+----+----+----+----|                   |----+----+----+----+----+----|
  //              `----+----+----+'     `----+----+----'
                          KC_ESC, KC_LALT,        KC_LGUI, KC_RCTRL,
  //              `----+----+----+'     `----+----+----'
...
//|----------+---------+--------+--------+-----------||--------+---------+---------+---------+----------|
    TO(_ALPH)/*S(KC_TAB)*/,  KC_LEFT, KC_DOWN, KC_RGHT, REOPEN_L,    CLOSE_T, PREV_TAB, NEXT_TAB,   KC_DEL,  RESET, /*DESK,*/
  //|----+----+----+----+----+----|                   |----+----+----+----+----+----|
  //              `----+----+----+'     `----+----+----'
                          KC_ESC, KC_LALT,        KC_LGUI, KC_RCTRL,
  //              `----+----+----+'     `----+----+----'
...
//|------------+------------+------------+------------+-------------|  |------------+------------+------------+------------+--------------|
    TO(_ALPH)/*APP_Z_STUDI*/, APP_X_XCODE, APP_C_CALCU, APP_V_VVVVV, KC_B/*APP_B_BOOKS*/,     APP_N_NOTES,  APP_M_MAIL, APP_ES_KEYN, APP_BS_PAGE, RESET, /*APP_EN_NUMB,*/
  //|----+----+----+----+----+----|                   |----+----+----+----+----+----|
  //              `----+----+----+'     `----+----+----'
                          KC_ESC, KC_LALT,        KC_LGUI, KC_RCTRL,
  //              `----+----+----+'     `----+----+----'
...
* |      |LCKSCR|onHold|onHold|      |  | lev.8| lev.1|Vol.Up|VolDwn| Vol. |
* |LOGOUT|@@@@@@| _RGBL| RESET|      |  | _TEST| _LAST| _RGBL|@@@@@@| Mute |
* |------+------+------+------+------|  |------+------+------+------+------|
...
///////////////////////////////////////////////////////////////// ### BLOCK ### OF LINES TOO LONG !!! ###
//,-------------------------------------------------------------------------.  ,-----------------------------------------------------------------------------.
     TD(LOGOUT),       LCK_SCR,      MO(_RGBL),    TD(HRESET),     XXXXXXX,      TD(V8_TEST), TD(V1_LAST), LT(_RGBL,  KC__VOLUP), KC__VOLDOWN,     KC__MUTE,
//|------------+--------------+---------------+--------------+--------------|  |------------+------------+----------------------+------------+---------------|
        KC_RSFT, RCTL_T(KC_F7), RALT_T(KC_SPC), RGUI_T(KC_F9), ZOOM_SMOOTH,      ZOOM_FOLLOW, TD(RG_ZOOM),           TD(RA_ZOIN), TD(RC_ZOUT),  TD(RS_INCO),
//|------------+--------------+---------------+--------------+--------------|  |------------+------------+----------------------+------------+---------------|
    TO(_ALPH)/*SLEP_MNUBAR*/,   KILAPP_DOCK,    KILMNU_TOOL,   SHUTD_STATB, RSTRT_FLOAT,       CONTRST_UP,    BRIGHT_1,               KC_PAUS,     KC_SLCK, RESET, /*CONTRST_DWN,*/
  //|----+----+----+----+----+----|                   |----+----+----+----+----+----|
  //              `----+----+----+'     `----+----+----'
                          KC_ESC, KC_LALT,        KC_LGUI, KC_RCTRL,
  //              `----+----+----+'     `----+----+----'
...
// LEFT_HAND
//,-------------------------------------------------------------------------.
     TD(LOGOUT),       LCK_SCR,      MO(_RGBL),    TD(HRESET),     XXXXXXX,
//|------------+--------------+---------------+--------------+--------------|
...
//|----------+----------|----------+----------+----------|  |--------------------+--------------+--------------+----------------+---------------|
    TO(_ALPH)/*MO(_ZVIM)*/, MO(_XVIM), MO(_CVIM), MO(_PVIM), XXXXXXX,      LCTL(LGUI(KC_DOWN)), LALT(KC_HOME), LALT(KC_PGUP), LALT(KC_PGDOWN), RESET, /*LALT(KC_END),*/
  //|----+----+----+----+----+----|                   |----+----+----+----+----+----|
  //              `----+----+----+'     `----+----+----'
                          KC_ESC, KC_LALT,        KC_LGUI, KC_RCTRL,
  //              `----+----+----+'     `----+----+----'
...
//|--------+--------+--------+--------+---------||--------+------------+--------+--------+--------------|
    TO(_ALPH)/*_______*/, _______, _______, _______, XXXXXXX,   XXXXXXX,      DVIM_M, DVIM_ES, DVIM_BS, RESET, /*DVIM_EN,*/
  //|----+----+----+----+----+----|                   |----+----+----+----+----+----|
  //              `----+----+----+'     `----+----+----'
                          KC_ESC, KC_LALT,        KC_LGUI, KC_RCTRL,
  //              `----+----+----+'     `----+----+----'
...
//|--------+--------+--------+--------+----------|  |--------+-------+--------+--------+----------|
    TO(_ALPH)/*_______*/, _______, _______, _______, XXXXXXX,       CVIM_N, CVIM_M, CVIM_ES, CVIM_BS, RESET, /*CVIM_EN,*/
  //|----+----+----+----+----+----|                   |----+----+----+----+----+----|
  //              `----+----+----+'     `----+----+----'
                          KC_ESC, KC_LALT,        KC_LGUI, KC_RCTRL,
  //              `----+----+----+'     `----+----+----'
...
//|--------+--------+--------+--------+----------|  |-------+-------+--------+--------+----------|
    TO(_ALPH)/*_______*/, _______, _______, _______, XXXXXXX,      XVIM_N, XVIM_M, XVIM_ES, XVIM_BS, RESET, /*XVIM_EN,*/
  //|----+----+----+----+----+----|                   |----+----+----+----+----+----|
  //              `----+----+----+'     `----+----+----'
                          KC_ESC, KC_LALT,        KC_LGUI, KC_RCTRL,
  //              `----+----+----+'     `----+----+----'
...
//|--------+--------+--------+--------+----------|  |-------+--------+--------+--------+----------|
    TO(_ALPH)/*_______*/, _______, _______, _______, XXXXXXX,      ZVIM_N,  ZVIM_M, ZVIM_ES, ZVIM_BS, RESET, /*ZVIM_EN,*/
  //|----+----+----+----+----+----|                   |----+----+----+----+----+----|
  //              `----+----+----+'     `----+----+----'
                          KC_ESC, KC_LALT,        KC_LGUI, KC_RCTRL,
  //              `----+----+----+'     `----+----+----'
...
//|--------+--------+--------+--------+----------|  |--------+--------+--------+--------+----------|
    TO(_ALPH)/*KC_ACL0*/, KC_ACL2, XXXXXXX, KC_ACL1, KC_ACL0,      KC_BTN1, KC_BTN2, KC_BTN3, KC_BTN4,  RESET, /*KC_BTN5,*/
  //|----+----+----+----+----+----|                   |----+----+----+----+----+----|
  //              `----+----+----+'     `----+----+----'
                          KC_ESC, KC_LALT,        KC_LGUI, KC_RCTRL,
  //              `----+----+----+'     `----+----+----'
...
/*  
*  Keymap _RGBL 15: BACKLIT - BackLIghT layer
* ,--------------------------------------------.  ,---------------------------------------------.
...
[_RGBL] = KEYMAP( // layer 15: _RGBL layer
  _______,   _______,  _______, RGB_MOD, RGB_HUD,             RGB_HUI, RGB_SAD, RGB_SAI,  RGB_VAD,  RGB_VAI, \
  RGB_M_R,  _______,    _______,  _______, _______,             _______,  _______, _______,   _______,  _______, \
  TO(_ALPH)/*RGB_TOG*/, RGB_MOD, RGB_RMOD, RGB_HUD, RGB_HUI,             RGB_SAD, RGB_SAI, RGB_VAD, KC_LEDON,  RESET, \
  //|----+----+----+----+----+----|                   |----+----+----+----+----+----|
  //              `----+----+----+'     `----+----+----'
                          KC_ESC, KC_LALT,        KC_LGUI, KC_RCTRL,
  //              `----+----+----+'     `----+----+----'
...
*/
// _LAST layer 17
[_LAST] = KEYMAP( // layer 17 : _LAST layer
//,----------------------------------------------.  ,----------------------------------------------.
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,      XXXXXXX, KC_WH_L, KC_WH_U, KC_WH_D, TO(_ALPH),/*KC_WH_R,*/
//|--------+--------+--------+--------+----------|  |--------+--------+--------+--------+----------|
    _______, _______, _______, _______, XXXXXXX,      XXXXXXX, KC_MS_L, KC_MS_U, KC_MS_D, KC_MS_R,
//|--------+--------+--------+--------+----------|  |--------+--------+--------+--------+----------|
    TO(_ALPH)/*KC_ACL0*/, KC_ACL2, XXXXXXX, KC_ACL1, KC_ACL0,      KC_BTN1, KC_BTN2, KC_BTN3, KC_BTN4, RESET, /*KC_BTN5,*/
...
[_TEST] = KEYMAP(  // layer 16 : _TEST layer
// ###
///////////////////////////////////////////////////////////////// ### BLOCK ### OF LINES TOO LONG !!! ###
//,-----------------------------------------------------------------------------.  ,-----------------------------------------------------------------------------------.
           KC_PLUS,          KC_AT,        KC_HASH,         KC_EQL,    KC_PERC,            TD(Y_AMCI),         BEEP_1,         BEEP_2,         BEEP_3, TO(_ALPH),/*KC_MINS,*/
//|---------------+---------------+---------------+---------------+-------------|  |-----------------+---------------+---------------+---------------+-----------------|
    LSFT_T(KC_GRV), CTL_T(KC_QUOT), ALT_T(KC_BSLS), GUI_T(KC_SLSH), TD(G_DOEU),               KC_PIPE, GUI_T(KC_LBRC), ALT_T(KC_RBRC), CTL_T(KC_COMM), LSFT_T(KC_DOT),
//|---------------+---------------+---------------+---------------+-------------|  |-----------------+---------------+---------------+---------------+-----------------|
        TO(_ALPH)/*TD(Z_EXCL)*/,     TD(X_QUES),        KC_LABK,        KC_RABK,    KC_ASTR,      LT(_SYMB, KC_NO),        KC_LCBR,        KC_RCBR,        KC_COLN, RESET, /*KC_SCLN,*/
