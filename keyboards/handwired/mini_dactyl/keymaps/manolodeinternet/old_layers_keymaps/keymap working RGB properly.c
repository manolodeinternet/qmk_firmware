...
//////////////////////////////////////////////////////////////////////////////////////////
#define OUTER_RGHT     0
#define OUTER_RGHT_ANIMATION_START     1

#define INNER_RGHT_ANIMATION_END       5
#define INNER_RGHT  6

// LEFT HAND
#define INNER_LEFT  7
#define INNER_LEFT_ANIMATION_START     8

#define OUTER_LEFT_ANIMATION_END      11
...
// MACROS FOR _RGBL 15
// RED
    ,CH_RED  ,CH_CORL ,CH_ORNG ,CH_GOLR ,CH_GOLD          ,CH_YLLW
// GREEN
...
/*
void get_default_hsv(void)
{
  default_hue = rgblight_config.hue;
    char string_my_hue[4]; // = "ok.";
    itoa(default_hue, string_my_hue, 10);
    send_string(string_my_hue);
 
  default_sat = rgblight_config.sat;
    char string_my_sat[4]; // = "ok.";
    itoa(default_sat, string_my_sat, 10);
    send_string(string_my_sat);

  default_val = rgblight_config.val;
    char string_my_val[4]; // = "ok.";
    itoa(default_hue, string_my_val, 10);
    send_string(string_my_val);
}
*/
...
{
// this consumes EEPROM cycles of life
// eeconfig_init_user();
...
//  this doesn't work
//////////////////////////////////////////////////////////////////////////////////////////////////////###
//    rgblight_config.hue = default_hue;
//    rgblight_config.sat = default_sat;
//    rgblight_config.val = default_val;

//    eeconfig_update_rgblight(rgblight_config.raw);
//////////////////////////////////////////////////////////////////////////////////////////////////////###
//

//    next block works perfectly as unique line by itself.
//////////////////////////////////////////////////////////////////////////////////////////////////////###
//      LED_TYPE tmp_led;
//      sethsv(default_hue, default_sat, default_val, &tmp_led);
//      rgblight_setrgb(tmp_led.r, tmp_led.g, tmp_led.b); //without this line two previous lines don't work
//////////////////////////////////////////////////////////////////////////////////////////////////////###
//
}
*/
...
/*
  ...
  {
    backlight_caps  = true;
    rgblight_setrgb_range(RGB_RED, 6, 8 //INNER_RGHT );
*/
/*
...
/*
  ...
  else
  {
    ...
    rgblight_setrgb_range(0x00, 0x00, 0x00, 6, 8 //INNER_RGHT );
*/
...
//        { printf("whole:true, rgb_numb:true.  %i, %i\n", OUTER_RGHT, INNER_RGHT + 1 );
      }
      else // rgb_num = false 
      {
        // LEFT = red
...
//        // red on both hands
//        { printf("whole:true, rgb_numb:false.  %i, %i\n", OUTER_RGHT, OUTER_LEFT + 1 );
//          setrgb_range(RGB_RED, OUTER_RGHT,
//                                OUTER_LEFT                             + 1 );
      }
    }
...
//        // red only on right hand
//        { printf("whole:false, rgb_numb:true.  %i, %i\n",
//                 INNER_RGHT - diff - 1,
//                 INNER_RGHT + 1 );
      }
      else // rgb_num = false 
...
//        // red on both hands
//        { printf("whole:false, rgb_numb:false.  %i, %i\n",
//                  INNER_RGHT - diff - 1,
//                  INNER_LEFT + diff + 1 );
      }
      // rght = default color
...
// default color for right side zone
//        printf("DEFAULT COLOR FOR RIGHT SIDE - whole:ALWAYS, rgb_numb:ALWAYS.  %i, %i\n",
//                                OUTER_RGHT,
//                                INNER_RGHT - diff - 1 );

        // default color for left side zone
//        printf("DEFAULT COLOR FOR LEFT  SIDE - whole:ALWAYS, rgb_numb:ALWAYS.  %i, %i\n",
//                                INNER_LEFT + diff + 1,
//                                OUTER_LEFT                             + 1 );
...
// ###
//                                              ,------------------+--------------------,   ,------------------+--------------------,
                                                          MO(_MOUS),         MO(_FUNC),               MO(_POWR),         MO(_ACCN),
//                                                      |----------+--------------------|   |------------------+--------------------|
                                                                                  KC_1,                    KC_2,
//                                                               |----------------------|   |--------------------|
...
//|---------|--------|---------+--------+----------| |---------|---------+---------+---------+----------|
     _______, _______,  _______, _______, _______,     F(TIL_N),  _______,  _______,  _______, RESET,//__
//|---------+--------+---------+--------+----------| |---------+---------+---------+---------+----------|
//                             ,--------+----------, ,--------+----------,
...
//|--------------+--------------+---------------+--------------+-------------|  |-----------+------+------+------+----------|
           KC_ENT,       KC_BSPC,         KC_TAB,        KC_EQL,    KC_PERC,      TD(SLNUMB),  KC_1,  KC_2,  KC_3, RESET, /*KC_ASTR,*/
//,--------------------------------------------------------------------------.  ,-------------------------------------------.
//                                                       ,--------+----------,  ,--------+----------,
                                                           _______, _______,      _______, _______,
//                                                       |--------+----------|  |--------+----------|
...
//|---------------+---------------+---------------+---------------+-------------|  |-----------------+---------------+---------------+---------------+-----------------|
        TD(Z_EXCL),     TD(X_QUES),        KC_LABK,        KC_RABK,    KC_ASTR,      LT(_SYMB, KC_NO),        KC_LCBR,        KC_RCBR,        KC_COLN, RESET, /*KC_SCLN,*/
//,-----------------------------------------------------------------------------'  '-----------------------------------------------------------------------------------.
//                                                          ,--------+----------,  ,--------+----------,
                                                              _______, _______,      _______, _______,
//                                                          |--------+----------|  |--------+----------|
...
//|-------+-------+-------+-------+----------|           |--------+--------+--------+--------+----------|
    KC_F21, KC_F22, KC_F23, KC_F24, XXXXXXX,               XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, RESET,//XX
//'------------------------------------------'           '----------------------------------------------.
//                       ,--------+----------,           ,--------+----------,
                           _______, _______,               _______, _______,
//                       |--------+----------|           |--------+----------|
...
//|----------+---------+--------+--------+-----------||--------+---------+---------+---------+----------|
    S(KC_TAB),  KC_LEFT, KC_DOWN, KC_RGHT, REOPEN_L,    CLOSE_T, PREV_TAB, NEXT_TAB,  KC_DEL,RESET,//DESK
//'--------------------------------------------------''-------------------------------------------------'
//                               ,--------+----------,,--------+----------,
                                   _______, _______,    _______, _______,
//                               |--------+----------||--------+----------|
...
///////////////////////////////////////////////////////////////// ### BLOCK ### OF LINES TOO LONG !!! ###
//,-----------------------------------------------------------------.  ,------------------------------------------------------------------.
        _______, APP_W_TWTTR, APP_E_EVERN, APP_R_RRRRR, APP_T_TERMI,     APP_Y_TYPIN, APP_U_SUBLI, APP_I_TEDIT, APP_O_OMNIF,     _______,
//|------------+------------+------------+------------+-------------|  |------------+------------+------------+------------+--------------|
    APP_A_SNOTE, APP_S_SAFAR, APP_D_D_ONE, APP_F_FINDE, APP_G_CHRME,     APP_H_SKTCH, APP_J_JJJJJ, APP_K_KVIEW, APP_L_CLNDR, APP_P_SPREF,
//|------------+------------+------------+------------+-------------|  |------------+------------+------------+------------+--------------|
    APP_Z_STUDI, APP_X_XCODE, APP_C_CALCU, APP_V_VVVVV, APP_B_BOOKS,     APP_N_NOTES,  APP_M_MAIL, APP_ES_KEYN, APP_BS_PAGE, RESET,//NUMBER
//'-----------------------------------------------------------------'  '------------------------------------------------------------------'
//                                              ,--------+----------,  ,--------+----------,
                                                  _______, _______,      _______, _______,
//                                              |--------+----------|  |--------+----------|
...
* ,----------------------------------.  ,----------------------------------.
* | Step |@@@@@@|      |*XXXXX|      |  |midVol|minVol|      |@@@@@@|      |
* |throug|LOGOUT|LCKSCR|onHold|      |  | lev.8| lev.1|Vol.Up|VolDwn| Vol. |
...
* |@RShft|@RCtrl|@RAlt |@RCmnd|      |  | Focus|@RCmnd|@RAlt |@RCtrl|@RShft|
* |------+------+------+------+------|  |------+------+------+------+------|
...
///////////////////////////////////////////////////////////////// ### BLOCK ### OF LINES TOO LONG !!! ###
//,-------------------------------------------------------------------------.  ,-----------------------------------------------------------------------------.
     TD(ST_IND),    TD(LOGOUT),        LCK_SCR,    TD(HRESET),     XXXXXXX,      TD(V8_TEST), TD(V1_LAST), LT(_RGBL,  KC__VOLUP), KC__VOLDOWN,     KC__MUTE,
//|------------+--------------+---------------+--------------+--------------|  |------------+------------+----------------------+------------+---------------|
     TD(TG_IND), RCTL_T(KC_F7), RALT_T(KC_SPC), RGUI_T(KC_F9), ZOOM_SMOOTH,      ZOOM_FOLLOW, TD(RG_ZOOM),           TD(RA_ZOIN), TD(RC_ZOUT),  TD(RS_INCO),
//|------------+--------------+---------------+--------------+--------------|  |------------+------------+----------------------+------------+---------------|
    SLEP_MNUBAR,   KILAPP_DOCK,    KILMNU_TOOL,   SHUTD_STATB, RSTRT_FLOAT,       CONTRST_UP,    BRIGHT_1,               KC_PAUS,     KC_SLCK, RESET,//CONT_DW
//'-------------------------------------------------------------------------'  '-----------------------------------------------------------------------------'
//                                                      ,--------+----------,  ,--------+----------,
                                                          _______, _______,      _______, _______,
//                                                      |--------+----------|  |--------+----------|
...
// LEFT_HAND
//,-------------------------------------------------------------------------.
     TD(ST_IND),    TD(LOGOUT),        LCK_SCR,    TD(HRESET),     XXXXXXX,
//|------------+--------------+---------------+--------------+--------------|
...
//'-------------------------------------------------------------------------'
                          ...
                          // RIGHT_HAND
                          ,-----------------------------------------------------------------------------.
                            TD(V8_TEST), TD(V1_LAST), LT(_RGBL,  KC__VOLUP), KC__VOLDOWN,     KC__MUTE,
                          |------------+------------+----------------------+------------+---------------|
...
//|----------+----------|----------+----------+----------|  |--------------------+--------------+--------------+----------------+---------------|
    MO(_ZVIM), MO(_XVIM), MO(_CVIM), MO(_PVIM), XXXXXXX,LCTL(LGUI(KC_DOWN)),LALT(KC_HOME),LALT(KC_PGUP),LALT(KC_PGDOWN),TD(HRESET),//LALT(KC_END)
//'------------------------------------------------------'  '-----------------------------------------------------------------------------------'
//                                    ,--------+---------,  ,--------+----------,
                                        _______, _______,     _______, _______,
//                                    |--------+---------|  |--------+----------|
...
//|--------+--------+--------+--------+---------||--------+------------+--------+--------+--------------|
    _______, _______, _______, _______, XXXXXXX,   XXXXXXX,   DVIM_M,DVIM_ES,DVIM_BS,TD(HRESET),//DVIM_EN
//'---------------------------------------------''------------------------------------------------------'
//                           ,--------+---------,,--------+----------,
                               _______, _______,   _______, _______,
//                           |--------+---------||--------+----------|
...
//|--------+--------+--------+--------+----------|        |--------+-------+--------+--------+----------|
    _______, _______, _______, _______, XXXXXXX,       CVIM_N,CVIM_M,CVIM_ES,CVIM_BS,TD(HRESET),//CVIM_EN
//'----------------------------------------------'        '---------------------------------------------'
//                            ,--------+---------,        ,--------+----------,
                                _______, _______,           _______, _______,
//                            |--------+---------|        |--------+----------|
...
//|--------+--------+--------+--------+----------|         |-------+-------+--------+--------+----------|
    _______, _______, _______, _______, XXXXXXX,       XVIM_N,XVIM_M,XVIM_ES,XVIM_BS,TD(HRESET),//XVIM_EN
//'----------------------------------------------'         '--------------------------------------------'
//                            ,--------+---------,         ,--------+----------,
                                _______, _______,            _______, _______,
//                            |--------+---------|         |--------+----------|
...
//|--------+--------+--------+--------+----------|        |-------+--------+--------+--------+----------|
    _______, _______, _______, _______, XXXXXXX,       ZVIM_N,ZVIM_M,ZVIM_ES,ZVIM_BS,TD(HRESET),//ZVIM_EN
//'----------------------------------------------'        '---------------------------------------------'
//////////////////////////////////////////////////////////////////////////////////////////////////////###
//                           ,--------+---------,         ,--------+----------,
                               _______, _______,            _______, _______,
...
//|--------+--------+--------+--------+----------|       |--------+--------+--------+--------+----------|
    KC_ACL0, KC_ACL2, XXXXXXX, KC_ACL1, KC_ACL0,     KC_BTN1,KC_BTN2,KC_BTN3,KC_BTN4,TD(HRESET),//KC_BTN5
//'----------------------------------------------'       '----------------------------------------------'
//                            ,--------+---------,       ,--------+----------,
                                _______, _______,          _______, _______,
//                            |--------+---------|       |--------+----------|
...
* |          |        |           |         |        |  |        | DECREMENT| INCREMENT|  COLOR | RGB MODE|
* '--------------------------------------------------'  '-------------------------------------------------'
*/
// _RGBL layer 15
[_RGBL] = KEYMAP( // layer 15: _RGBL layer
//'-----------------------------------------------'     '-------------------------------------------------'
     CH_RED, CH_CORL, CH_ORNG, CH_GOLR, CH_GOLD,          CH_YLLW, RGB_HUD, RGB_HUI, _______,   RGB_RMOD,
...
/*       
        ...
        //|----+----+----+----+----+----|                                                         |----+----+----+----+----+----|
                A  , R  , S  , T  , D  ,                                                            H  , N  , E  , I  , O  ,
        //|----+----+----+----+----+----|                                                         |----+----+----+----+----+----|
                Z  , X  , C  , V  , B  ,                                                            K  , M  ,COMM,DOT ,REST,//SLSH
        //|----+----+----+----+----+----|                                                         |----+----+----+----+----+----|
        //`----+----+----+----+----+----'                                                         `----+----+----+----+----+----'
*/
/*
...
// An     empty keycode is as    'TRNS' in a 'KC_KEYMAP'
// A  '_______' keycode is as 'KC_TRNS' in a    'KEYMAP'
/*
        [_LOWER] = KC_KEYMAP(
        //,----+----+----+----+----+----.                                                      ,----+----+----+-----+----+----.
        //|----+----+----+----+----+----|                                                      |----+----+----+-----+----+----|
        ...
        //|----+----+----+----+----+----|                                                      |----+----+----+----+----+----|
                REST ,1, 1  , 1  , LEDON ,                                                        NO,   0,   0, DOT,REST,//NO
        //|----+----+----+----+----+----|                                                      |----+----+----+----+----+----|
        //`----+----+----+----+----+----'                                                      `----+----+----+----+----+----'
        //                               `----+----+----+'                     `----+----+----'
                                               PGUP,PGDN,                       HOME, END,
        ...
        //|----+----+----+----+----+-----|                                                      |----+-----+----+-----+----+----|
                    ,  UP,    ,    ,    ,                                                            ,     , UP ,     ,    ,
        //|----+----+----+----+----+-----|                                                      |----+-----+----+-----+----+----|
                LEFT,DOWN,RIGHT,   ,LEDON,                                                      LEDON, LEFT,DOWN,RIGHT,REST,
        //`----+----+----+----+----+-----'                                                      `----+-----+----+-----+----+----'
        //`----+----+----+----+----+-----'                                                      `----+-----+----+-----+----+----'
...
/*
       ...
       F(CAPSL), _______,    AU_ON,  AU_OFF, AG_NORM, AG_SWAP,  QWERTY, COLEMAK,  DVORAK, _______, \
        RGB_TOG, RGB_MOD, RGB_RMOD, RGB_HUD, RGB_HUI, RGB_SAD, RGB_SAI, RGB_VAD, RGB_VAI, KC_REST, \
...
/* [ADAPTATION]  breathing_disable(); [adaptation] */
...
*/
      ...
      case CH_TRQS: default_r = 0x47; default_g = 0x6E; default_b = 0x6A; change_RGB_color(); return false; break;
      case CH_TEAL: default_r = 0x00; default_g = 0x80; default_b = 0x80; change_RGB_color(); return false; break;
...
// _ZVIM
      ...
      case DICTAD:
/*
// [ADAPTATION] FROM GHERKIN TO MINIDACTYL
      case BLIT_OFF:
      case BLIT_01:
      case BLIT_02:
      case BLIT_03:
