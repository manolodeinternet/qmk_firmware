...
#pragma once
#ifndef RGBLIGHT_MINI_DACTYL_H
#define RGBLIGHT_MINI_DACTYL_H
...
#define HSV_MY_LIGHT_CORAL    0, 120, 240 //(  0°,  47%,  94%)✔︎
#define HSV_MY_LIGHT_CORAL_2  0, 166, 255 //(  0°,  65%, 100%)✔︎
#define HSV_MY_RED            0, 255, 255 //(  0°, 100%, 100%)✔︎
#define HSV_MY_DARK_CORAL     5, 255, 255 //(  7°, 100%, 100%)✔︎
#define HSV_MY_ORANGE_RED    11, 255, 255 //( 16°, 100%, 100%)✔︎
#define HSV_MY_CORAL         13, 255, 255 //( 18°, 100%, 100%)✔︎
